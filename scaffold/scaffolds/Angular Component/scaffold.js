...
/**
 * Creates a new Angular component with templates, styles and specs. Registers
    ...
    return inquirer.prompt([
        {
            type: 'string',
            name: 'name',
            message: 'What is the name of this new Angular Component?',
        ...
        assemble
            ...
            .pipe(rename(path => {
                path.basename = path.basename.replace('Component', answers.name);
                if (path.extname === '.js') {
